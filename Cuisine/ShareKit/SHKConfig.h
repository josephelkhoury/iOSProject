...
#define SHKMyAppName			@"Partage de Saveurs"
...
#define SHKFacebookKey				@"395854400478133"
#define SHKFacebookSecret			@"21a9da473da86a26faad38ad342a6fb4"
 ...
 */
#define SHKTwitterConsumerKey		@"zUo6YB3yt2qZEQMR1SM2oA"
#define SHKTwitterSecret			@"b1MpAcYNigXJK8umg9lVO1ZMq0SO9dFZ5AYwai5uM"
#define SHKTwitterCallbackUrl		@"http://www.twitter.com" // You need to set this if using OAuth, see note above (xAuth users can skip it)
